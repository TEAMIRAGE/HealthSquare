    ...
    try {
      ...
      if (selectedOption === "Fracture") {
        ...
        stream.on("finish", async () => {
          ...
          let resultString = "";
          if (response.data.includes("No fracture is detected")) {
          ...
          } else if (response.data.includes("Fracture is present")) {
      ...
      // %%%%%%%%%%%%%%%%%%%%% TUMOR START %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        stream.on("finish", async () => {
          ...
          const response = await axios.get(
            `${ip1}${port1}/tumor-Processing-result/${gcBucketFileName}`
          );
          console.log(response.data);

          let resultImage = "kuch nhi";
          let resultString = "";
          if (response.data.includes("no_tumor")) {
            resultImage = "images/green-tick.png";
          ...
          } else if (response.data.includes("glioma_tumor")) {
            resultImage = "images/red-tick.png";
          ...
          } else if (response.data.includes("meningioma_tumor")) {
            resultImage = "images/red-tick.png";
          ...
          } else if (response.data.includes("pituitary_tumor")) {
            resultImage = "images/red-tick.png";
            ...
            await userProfile_Database.findById(data.UserId);
            res.render("resultOutput.ejs", {
              name: userName.name,
              resultImage: resultImage,
              resultString: resultString,
